    ...
    public class QDatabase
    {
        ...
        public QDatabase()
        {
               ...
               answers = new List<KeyValuePair<string, string>>() // ÄNDRA TILL NUMMER
            {
                 ...
                 new KeyValuePair<string,string>("Geograpy","Germany"),
            ...
            alternatives = new List<KeyValuePair<string, List<string>>>()
            {
                ...
                new KeyValuePair<string,List<string >>("Geograpy",q5),
                new KeyValuePair<string, List<string>>("Geograpy",q6),
                new KeyValuePair<string, List<string>>("Geograpy",q7),
                new KeyValuePair<string, List<string>>("Geograpy",q8),
